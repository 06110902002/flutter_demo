...
import 'package:test_flutter/StickyHeader/codeSticky/widgets/sliver_sticky_header.dart';

import 'common.dart';

class AnimatedHeaderExample extends StatelessWidget {
  const AnimatedHeaderExample({Key? key}) : super(key: key);
...
class _StickyHeaderList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverStickyHeader.builder(
      builder: (context, state) => _AnimatedHeader(state: state, index: index),
      sliver: SliverList(
...
class _AnimatedHeader extends StatelessWidget {
  const _AnimatedHeader({Key? key, this.state, this.index}) : super(key: key);
