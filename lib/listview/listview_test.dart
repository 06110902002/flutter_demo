/// FileName listview_test
///
/// @Author 505691285qq.com
/// @Date 2025/12/18 10:38
///
/// @Description TODO
...
//   List<String> cityNames = ['北京', '上海', '广州', '深圳'];
//   bool _isLoadingMore = false;
//   bool _isRefreshing = false; // 添加一个标志位，用于判断是否正在刷新
//
//   @override
//   void initState() {
//     super.initState();
...
//     setState(() {
//       cityNames = cityNames.reversed.toList(); // 反转列表模拟刷新效果
//       _isRefreshing = false; // 清除正在刷新标志
//     });
//   }
//
...
//     setState(() {
//       cityNames.addAll(
//         List.generate(5, (index) => '新城市 ${index + cityNames.length}'),
//       );
...
//           controller: _scrollController, // 使用自定义的滚动控制器
//           itemCount: cityNames.length + 1, // 加1是为了显示加载更多提示
//           itemBuilder: (context, index) {
//             if (index == cityNames.length) {
//               // 显示加载更多提示
//               return _isLoadingMore
//                   ? Center(child: CircularProgressIndicator())
//                   : Center(child: Text('上拉加载更多...'));
//             }
//             return ListTile(title: Text(cityNames[index]));
//           },
//           physics: AlwaysScrollableScrollPhysics(), // 允许在内容高度不足时滚动
//         ),
//       ),
//     );
//   }
...
import 'package:flutter/material.dart';
import 'package:test_flutter/listview/ui/pull_and_push.dart';

void main() {
  // 在 main 函数中创建 MaterialApp
  runApp(
    MaterialApp(
      title: 'Flutter Scroll Demo',
      theme: ThemeData(primarySwatch: Colors.blue),
      home: PullAndPushTest(), // 将 PullAndPushTest 作为 home
    ),
  );
}
...
class PullAndPushTestState extends State<PullAndPushTest>
  ...
  var _result = "";
  String customRefreshBoxIconPath = "assets/imgs/icon_arrow.png";
  late AnimationController customBoxWaitAnimation;
  int rotationAngle = 0;
  ...
  void initState() {
    ...
    customBoxWaitAnimation = new AnimationController(
      duration: const Duration(milliseconds: 1000 * 100),
      vsync: this,
    );
    //第一次layout后会被调用
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(title: new Text("上下拉刷新")),
        ...
        children: <Widget>[
          new Align(
            ...
            child: new RotatedBox(
              ...
              child: new RotationTransition(
                ...
                turns:
                    new Tween(begin: 100.0, end: 0.0).animate(
                      customBoxWaitAnimation,
          ...
          new Align(
            ...
            child: new ClipRect(
              child: new Text(
                customHeaderTipText,
                style: new TextStyle(fontSize: 18.0, color: Color(0xffe6e6e6)),
              ),
            ),
          ),
        ],
  ...
  void _handleStateCallback(
    ...
    switch (animationStates) {
      ...
      case AnimationStates.StartLoadData:
        setState(() {
          customRefreshBoxIconPath = "assets/imgs/refresh.png";
      ...
      case AnimationStates.LoadDataEnd:
        ...
        setState(() {
          ...
          if (refreshBoxDirectionStatus == RefreshBoxDirectionStatus.PULL) {
            customRefreshBoxIconPath = "assets/imgs/icon_cry.png";
      ...
      case AnimationStates.RefreshBoxIdle:
        setState(() {
          ...
          customRefreshBoxIconPath = "assets/imgs/icon_arrow.png";
        });
        break;
    }
  }
