/// FileName easy_sample
///
/// @Author 505691285qq.com
/// @Date 2025/12/17 10:32
///
/// @Description  纯代码实现粘性头部组件

import 'package:flutter/material.dart';
import 'package:test_flutter/StickyHeader/codeSticky/reverse.dart';
import 'package:test_flutter/StickyHeader/codeSticky/side_header.dart';
...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(title: 'Flutter Sticky Headers', home: const _Home());
  }
}
